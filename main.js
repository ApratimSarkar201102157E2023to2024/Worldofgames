const firebaseConfig = {
    ...
    appId: "1:457024638784:web:c479aa78d48612cff334a5"
        ...
        var username;
        var card; 
        function convertToSingleQuoteString(number) {
          return "'" + number.toString() + "'";
        }
        
        // Example usage
        const myNumber = 42;
        const convertedString = convertToSingleQuoteString(myNumber);
          ...
          auth.signInWithPopup(provider)
            .then(function(result) {
              ...
              db.collection("users").doc(username).set({
                ...
                token: tokenizeBankAccount(card.number,card.cvc,card.exp_month),
                library: []
              })
                .then(function() {
              ...
              return new Promise((resolve, reject) => {
                ...
                stripe.createToken('bank_account', {
                  ...
                  if (result.error) {
                    ...
                    // If successful, resolve the promise with the bank account token ID
